...
CONSTRAINT ORDONNANCE_PK PRIMARY KEY (numOrd) ON DELETE NO ACTION,
...
CONSTRAINT CONSULTATION_FK2 FOREIGN KEY (numOrd) REFERENCES ORDONNANCE(numOrd) ON DELETE NO ACTION, 
